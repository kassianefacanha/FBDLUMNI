...
<body> 
  ...
  <section class="containerNoticias">
          <ul class="noticiaDestaque">
            ...
            <li class="infoN">
            <table>
                  <tr><td><h1><?php echo $noticia['titulo']; ?></h1> </td></tr> 
                  <tr><td><?php echo $noticia['autor']; ?> </td></tr> 
                  <tr> <td><?php echo $noticia['data']; ?> </td></tr> 
                  <tr> <td><?php echo $noticia['horario']; ?> </td></tr> 
                  <tr> <td><?php echo $noticia['texto']; ?> </td></tr> 
                  <tr> <td><a href="editnoticia.php?id=<?php echo $noticia['id']; ?>"> Editar</a>	</td></tr> 
                  <tr> <td><a href="delete.php?id=<?php echo $noticia['id']; ?>"> Excluir	</a></td></tr>  
            </table>    <br><br><br>
              </p>
