  ...
  <main class="containerPerfil">
    ...
    <form action="add.php" method="post">
      <h1>CADASTRO DE NOTÍCIA</h1>
        ...
        <input type="text" placeholder="Título"><input type="text" placeholder="Autor" name="noticia['autor']"><br><input type="date" placeholder="Data" name="noticia['data']">
        <input type="time" placeholder="Horário" name="noticia['horario']"><textarea  id="" cols="10" rows="10" placeholder="Texto da Publicação" name="noticia['textnoticia']"></textarea>
